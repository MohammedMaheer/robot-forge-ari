    ...
    <div className="min-h-screen bg-surface flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-text-secondary mt-1">Join the Physical AI data revolution</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="bg-surface-elevated border border-surface-border rounded-lg p-6 space-y-4">
          ...
          <div className="relative my-2">
            ...
            <div className="relative flex justify-center text-xs"><span className="px-2 bg-surface-elevated text-text-secondary">or sign up with</span></div>
          </div>
