    ...
    <div className="min-h-screen bg-surface flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-text-primary">Welcome to ROBOTFORGE</h1>
          <p className="text-sm text-text-secondary mt-1">Sign in to your Physical AI data platform</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="bg-surface-elevated border border-surface-border rounded-lg p-6 space-y-4">
          ...
          <div className="relative my-2">
            ...
            <div className="relative flex justify-center text-xs"><span className="px-2 bg-surface-elevated text-text-secondary">or continue with</span></div>
          </div>

          {/* OAuth Buttons */}
          <div className="grid grid-cols-2 gap-3">
            <a
              href={`${OAUTH_BASE}/api/auth/oauth/github`}
              className="flex items-center justify-center gap-2 py-2 border border-surface-border rounded-md text-sm text-text-secondary hover:bg-surface transition-colors"
            >
            ...
            <a
              href={`${OAUTH_BASE}/api/auth/oauth/google`}
              className="flex items-center justify-center gap-2 py-2 border border-surface-border rounded-md text-sm text-text-secondary hover:bg-surface transition-colors"
            >
          ...
          <p className="text-center text-xs text-text-secondary">
            ...
            <Link to="/register" className="text-mid-blue hover:underline">
              Create one
            </Link>
          </p>
        </form>
